...
//objeto para configurar el provider
function HashProvider() {
 ...
 //metodo que es realmente el factory y que crea el
 //valor del servicio
 /*En toda clase Provider es obligatorio que exista este método público llamado $get.*/
  this.$get=function() {
    var hashFunction;
...
//nuestro provider se llama hash;su otro argumento es el nombre de la clase
app.provider("hash",HashProvider);

//En el bloque config configuramos nuestro provider
